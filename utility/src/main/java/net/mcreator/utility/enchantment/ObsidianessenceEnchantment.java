...
public class ObsidianessenceEnchantment extends Enchantment {
	...
	protected boolean checkCompatibility(Enchantment enchantment) {
		return super.checkCompatibility(enchantment) && !List
				.of(UtilityModEnchantments.LAVAESSENCE.get(), UtilityModEnchantments.WATERESSENCE.get(), UtilityModEnchantments.CREEPERESSENCE.get(), UtilityModEnchantments.OBSIDIANESSENCE_2.get(), UtilityModEnchantments.PROJECTILE_ESSENCE.get())
