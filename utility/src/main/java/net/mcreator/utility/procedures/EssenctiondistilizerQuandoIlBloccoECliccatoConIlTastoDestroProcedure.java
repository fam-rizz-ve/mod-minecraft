...
public class EssenctiondistilizerQuandoIlBloccoECliccatoConIlTastoDestroProcedure {
		...
		if (entity instanceof ServerPlayer _ent) {
			...
			NetworkHooks.openScreen((ServerPlayer) _ent, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("EssenctiondistilizerGUI");
				}

				@Override
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					return new EssenctiondistilizerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
				}
			}, _bpos);
		}
		if (new Object() {
